...
import img1 from '../assets/image/zn1.jpg'
import img2 from '../assets/image/zn2.jpg'
import img3 from '../assets/image/zn3.jpg'
import img4 from '../assets/image/zn4.jpg'
import img5 from '../assets/image/zn5.jpg'
// import img6 from '../assets/image/zn6.jpg'
export default {
  name: 'customized', // 全屋定制
  components: { Pagination },
  data () {
    return {
      imgs: [
        { 'img': img1, 'title': '智能家具1' },
        { 'img': img2, 'title': '智能家具2' },
        { 'img': img3, 'title': '智能家具3' },
        { 'img': img4, 'title': '智能家具4' },
        { 'img': img5, 'title': '智能家具5' }
      ],
      listData: null,
      totalNum: 0, // 实景总数
      page: 1, // 当前页
